...
if __name__ == "__main__":
    ...
    grid_cols_count = 3  # <-- 设置为3, 代表切割成3列  (最终会得到 2x3=6 个小图)

    # 2. 输入图片路径
    input_image = "/home/cz/software/pycharm-2024.2.3/PycharmProjects/python-utils/assets/grid/multi/003.jpg"

    # 3. 输出文件夹路径
    output_folder = "/home/cz/software/pycharm-2024.2.3/PycharmProjects/python-utils/assets/grid/output"  # <-- 图片保存文件夹
